            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    <div class="card-content">
                        ...
                        <strong>Usuarios: </strong><?php echo ($row->usuarios) ? "Sí" : "No" ?>
                        <strong>Noticias: </strong><?php echo ($row->noticias) ? "Sí" : "No" ?><br>
                        <strong>Casas: </strong><?php echo ($row->casas) ? "Sí" : "No" ?>
                        <strong>Oficinas: </strong><?php echo ($row->oficinas) ? "Sí" : "No" ?>
                        <strong>Locales: </strong><?php echo ($row->locales) ? "Sí" : "No" ?>
                    </div>
                    <div class="card-action">
