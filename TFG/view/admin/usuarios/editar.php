...
<div class="row" style="padding-left: 20px;">
    ...
    <form class="col m12 l6" method="POST" action="<?php echo $_SESSION['home'] ?>admin/usuarios/editar/<?php echo $id ?>">
        ...
        <div class="row">
            ...
            <p>
                <label for="casas">
                    <input id="casas" name="casas" type="checkbox" <?php echo ($datos->casas == 1) ? "checked" : "" ?>>
                    <span>Casas</span>
                </label>
            </p>
            <p>
                <label for="oficinas">
                    <input id="oficinas" name="oficinas" type="checkbox" <?php echo ($datos->oficinas == 1) ? "checked" : "" ?>>
                    <span>Oficinas</span>
                </label>
            </p>
            <p>
                <label for="locales">
                    <input id="locales" name="locales" type="checkbox" <?php echo ($datos->locales == 1) ? "checked" : "" ?>>
                    <span>Locales</span>
                </label>
            </p>
            <p>
