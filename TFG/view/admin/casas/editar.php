<h3 style="margin-left: 15px;">
    ...
    <a href="<?php echo $_SESSION['home'] ?>admin/casas" title="Casas">Casas</a> <span>| </span>
    <?php if ($datos->id){ ?>
...
<div class="row">
    ...
    <form class="col s12" method="POST" enctype="multipart/form-data" action="<?php echo $_SESSION['home'] ?>admin/casas/editar/<?php echo $id ?>">
        <div class="col m12 l6">
            <div class="row">
                ...
                <div class="input-field col s12">
                    <input id="habitaciones" type="text" name="habitaciones" value="<?php echo $datos->habitaciones ?>">
        ...
        <div class="col m12 l6">
            ...
            <?php if ($datos->foto){ ?>
                <img class="img-editar" src="<?php echo $_SESSION['public']."img/casas/".$datos->foto ?>" alt="<?php echo $datos->titulo ?>">
            <?php } ?>
        </div>
        ...
        <div class="row">
            <div class="input-field col s12" style="margin: 0 0 100px 15px;">
                <a href="<?php echo $_SESSION['home'] ?>admin/casas" title="Volver">
