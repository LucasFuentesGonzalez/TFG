<h3 style="margin: 0 0 20px 15px;">
    <a href="<?php echo $_SESSION['home'] ?>admin" title="Inicio">Inicio</a> <span>| Casas</span>
</h3>
        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                <div class="card-content" style="height: 168px;">
                    <i class="grey-text material-icons medium">house</i>
                    <h4 class="grey-text">
                        nueva casa
                    </h4><br><br>
                </div>
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/casas/crear" ?>" title="Añadir nueva casa">
        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    <?php if ($row->imagen){ ?>
                        <div class="card-image">
                            <img src="<?php echo $_SESSION['public']."img/casas/".$row->imagen ?>" alt="<?php echo $row->titulo ?>">
                        </div>
                    <?php } ?>
                    ...
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/casas/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/casas/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <!--<a href="<?php //echo $_SESSION['home']."admin/casas/home/".$row->id ?>" title="<?php //echo $title ?>">
                ...
                <div class="card-reveal">
                    ...
                    <p>
                        ¿Está seguro de que quiere borrar la casa<strong><?php echo $row->titulo ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/casas/borrar/".$row->id ?>" title="Borrar">
