...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/Logo.svg" alt="Logo Empresa">
        </a>
        ...
        <?php if (isset($_SESSION['usuario'])){ ?>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <?php if ($_SESSION['casas'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/casas" title="Casas">Casas</a>
                    </li>
                <?php } ?>

                <?php if ($_SESSION['oficinas'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/oficinas" title="Oficinas">Oficinas</a>
                    </li>
                <?php } ?>

                <?php if ($_SESSION['locales'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/locales" title="Locales">Locales</a>
                    </li>
                <?php } ?>
