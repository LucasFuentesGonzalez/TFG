...
<h3 class="noticias-raiz" style="margin-top: 86px;">
    ...
    <a href="<?php echo $_SESSION['home'] ?>locales" title="Locales">Locales</a> <span>| </span>
    ...
    <article class="col s12">
        <div class="row card horizontal large" style="margin-bottom: 150px;">
            <div class="card-image">
                <img class="servicio-img" style="width: 750px;" src="<?php echo $_SESSION['public']."img/locales/".$datos->foto ?>" alt="<?php echo $datos->titulo ?>">
            </div>

            <div class="servicio-texto">
                <h4 class="servicio-titu"><?php echo $datos->titulo ?></h4>
                <p class="servicio-dis">Local en <?php echo $datos->distrito ?></p>
