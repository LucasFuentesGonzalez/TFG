...
<h3 class="noticias-raiz" style="margin-top: 86px;">
    <a href="<?php echo $_SESSION['home'] ?>" title="Inicio">Inicio</a> <span>| Locales</span>
</h3>
                ...
                <?php foreach ($datos as $row){ ?>
                    <article>
                        <div class="row card horizontal small">
                            <div class="row">
                                <div class="col">
                                    <img class="servicios-img" src="<?php echo $_SESSION['public']."img/locales/".$row->foto ?>" alt="<?php echo $row->titulo ?>">
                                </div>

                                <div class="col">
                                    <div class="servicios-texto">
                                        <p class="servicios-titu"><?php echo $row->titulo ?></p>
                                        <p class="servicios-dis">Local en <?php echo $row->distrito ?></p>
                                        ...
                                        <div>
                                            <a class="servicios-mas" href="<?php echo $_SESSION['home']."local/".$row->slug ?>">Más información</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
