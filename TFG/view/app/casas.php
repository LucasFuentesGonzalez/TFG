...
<h3 class="noticias-raiz" style="margin-top: 86px;">
    <a href="<?php echo $_SESSION['home'] ?>" title="Inicio">Inicio</a> <span>| Casas</span>
</h3>
...
<div style="padding: 30px 30px 30px 55px;">
    <div class="row">
        <div class="col">
            ...
            <div class="servicios-barra">
                <?php foreach ($datos as $row){ ?>
                    <article>
                        <div class="row card horizontal small">
                            <div class="row">
                                <div class="col">
                                    <img class="servicios-img" src="<?php echo $_SESSION['public']."img/casas/".$row->foto ?>" alt="<?php echo $row->titulo ?>">
                                </div>

                                <div class="col">
                                    <div class="servicios-texto">
                                        <p class="servicios-titu"><?php echo $row->titulo ?></p>
                                        <p class="servicios-dis">Casa en <?php echo $row->distrito ?></p>
                                        ...
                                        <div class="row servicios-iconos">
                                            ...
                                            <div class="col">
                                                <p class="servicios-habs"><i class="fa-solid fa-bed"></i><?php echo $row->habitaciones ?> habs</p>
                                            </div>
                                            <div class="col">
                                                <p class="servicios-planta"><i class="fa-solid fa-building"></i><?php echo $row->planta ?>ª Planta</p>
                                            </div>
                                        </div>

                                        <div>
                                            <a class="servicios-mas" href="<?php echo $_SESSION['home']."casa/".$row->slug ?>">Más información</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
