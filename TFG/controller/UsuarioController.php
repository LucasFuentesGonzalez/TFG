...
class UsuarioController
{
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            if ($usuario){
                ...
                if (password_verify($campo_clave,$usuario->clave)) {
                    ...
                    $_SESSION["casas"] = $usuario->casas;
                    $_SESSION["oficinas"] = $usuario->oficinas;
                    $_SESSION["locales"] = $usuario->locales;
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $casas = (filter_input(INPUT_POST, 'casas', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            $oficinas = (filter_input(INPUT_POST, 'oficinas', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            $locales = (filter_input(INPUT_POST, 'locales', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO usuarios (usuario, clave, noticias, casas, oficinas, locales, usuarios) VALUES ('$usuario','$clave_encriptada','$noticias','$casas','$oficinas','$locales','$usuarios')");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',noticias='$noticias',casas='$casas',oficinas='$oficinas',locales='$locales',usuarios='$usuarios' WHERE id='$id'") :
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',noticias='$noticias',casas='$casas',oficinas='$oficinas',locales='$locales',usuarios='$usuarios' WHERE id='$id'");
